<!DOCTYPE html>
  ...
  <?php $sql = 'SELECT * FROM receitas WHERE tipo_receita = :tipo_receita';
    ...
    $stmt->execute([':tipo_receita' => 'carne']);
    $receitas = $stmt->fetchAll(PDO::FETCH_ASSOC);
  ?>

<section class="receitas-carne mb-5" id="receitas-carne">
    <div class="container text-center">
        <h3 class="fw-bold">Receitas de Carne</h3>
        <p>Explore as melhores receitas de carne para impressionar a sua família e amigos.</p>
        <div class="row">
