<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Receitas com frutas</title>
  ...
  <?php $sql = 'SELECT * FROM receitas WHERE tipo_receita = :tipo_receita';
    ...
    $stmt->execute([':tipo_receita' => 'fruta']);
    $receitas = $stmt->fetchAll(PDO::FETCH_ASSOC);
  ?>

<section class="receitas-carne mb-5" id="receitas-carne">
    <div class="container text-center">
        <h3 class="fw-bold">Receitas com frutas</h3>
        <p>Explore as melhores receitas com frutas para impressionar a sua família e amigos.</p>
        <div class="row">
