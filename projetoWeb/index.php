        ...
        <div class="col-12 col-md-10 col-lg-6 offset-md-1 offset-md-3">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="2000">
              <a href="ovosbenedict.php"><img src="imgs/ovos-benedict-legumes-pao-cereais.jpeg" alt="Imagem do carousel" class="d-block w-100"></a>
            ...
            <div class="carousel-item" data-bs-interval="2000">
              <a href="batatasrecheadas.html"><img src="imgs/batatas-recheadas-com-carne.jpeg" alt="Imagem do carousel" class="d-block w-100"></a>
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" data-bs-interval="2000">
              <a href="lasanhasardinhas.html"><img src="imgs/lasagna-de-sardinha-e-curgete.jpg" alt="Imagem do carousel" class="d-block w-100"></a>
              <div class="carousel-caption d-none d-md-block">
        ...
        <div class="container text-center">
          <div class="row align.items-center">
            <div class="col-md-6 mb-4">
              ...
              <a href="ovosbenedict.php" class="btn mt-3" style="background-color:#5b3b1e; color:white;">Ver Mais</a>
            </div>
            <div class="col-md-6 mb-4">
        ...
        <div class="container text-center">
          <div class="row align.items-center">
            ...
            <div class="col-md-6 mb-4">
              ...
              <a href="batatasrecheadas.php" class="btn mt-3" style="background-color:#5b3b1e; color:white">Ver Mais</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container text-center">
          <div class="row align.items-center">
            <div class="col-md-6 mb-4">
              ...
              <a href="lasanhasardinhas.php" class="btn mt-3" style="background-color:#5b3b1e; color:white">Ver Mais</a>
            </div>
          ...
          <div class="col-md-4">
            <div class="card border-0 shadow h-100">
              ...
              <div class="card-body text-center">
                ...
                <a href="#" class="btn btn-sm btn-outline-dark">Ver Mais</a>
              </div>
            </div>
          </div>
